...
if choice1 == "left":
    choice2 = input('You have come to a lake, There is an island in the middle of the lake. Type "wait" to wait for a boat. Type "swim" is to swim across\n').lower()
    if choice2 == "wait":
        ...
        if choice3 == "red":
            ...
            print("Its room full of Tiger. Game Over")
        else:
            print("You chose the door doesn't exists. Game Over")
    else:
        print("You are attacked by and angry alligator. Game Over")
else:
